                ...
                html.Div(className="col-lg-4 mb-4",children=[
                    html.Div(className="card wow bounceInUp", children=[
                        ...
                        html.Div(className="card-body",children=[
                            ...
                            #html.P("aqui toca escribir algo",className="card-title"),
                            dbc.Button("GitHub", href="https://github.com/Jstoqui/MobiliData_DS4A_TEAM80", color="primary", className="mt-3")
                        ])                        
                    ])
                ]),
                html.Div(className="col-lg-4 mb-4",children=[
    ...
    html.Section(id='team',children=[
        html.Div(className="container",children=[
            html.Div(className="section-header", children=[
                ...
                html.P("Team number 80 is made up of a multidisciplinary group of professionals and passionate about data science, please hover over each one to find out.")
            ]),
            html.Div(className="row seven cols", children=[
                ...
                html.Div( className="col-lg-3 col-md-3 wow fadeInUp", children=[
                    html.Div(className='member', children=[
                        html.Img(src="/assets/img/Marcela2.jpg",className="img-fluid"),
                        html.Div(className="member-info", children=[
                            html.Div(className="member-info-content", children=[
                    ...
                    html.Div(className='member', children=[
                        ...
                        html.Div(className="member-info", children=[
                            html.Div(className="member-info-content", children=[
                                ...
                                html.Span('Transport Engineer'),
                                html.Span('Data Analyst'),                                
                                html.Div(className="social",children=[
                                    html.A(href="https://www.linkedin.com/in/m%C3%B3nica-ot%C3%A1lora-montenegro-603bb9108/",children=[
                                        html.I(className="fa fa-linkedin")
                                    ])
                                ])
                            ])
                    ...
                    html.Div(className='member', children=[
                        ...
                        html.Div(className="member-info", children=[
                            html.Div(className="member-info-content", children=[
                                ...
                                html.Span('Software Engineer'),                                
                                html.Div(className="social",children=[
                                    html.A(href="https://www.linkedin.com/in/nicolas-roldan-fajardo/",children=[
                                        html.I(className="fa fa-linkedin")
                                    ])
                                ])
                            ])
                    ...
                    html.Div(className='member', children=[
                        ...
                        html.Div(className="member-info", children=[
                            html.Div(className="member-info-content", children=[
                                ...
                                html.Span('Electrical Engineer'),
                                html.Span('Data Scientist'),                                
                                html.Div(className="social",children=[
                                    html.A(href="https://www.linkedin.com/in/vicentecastro/",children=[
                                        html.I(className="fa fa-linkedin")
                                    ])
                                ])
                            ])
                    ...
                    html.Div(className='member', children=[
                        ...
                        html.Div(className="member-info", children=[
                            html.Div(className="member-info-content", children=[
                                ...
                                html.Div(className="social",children=[
                                    html.A(href="https://www.linkedin.com/in/nicol%C3%A1s-escobar-pinz%C3%B3n-807813a5/",children=[
                                        html.I(className="fa fa-linkedin")
                                    ]),
                                    html.A(href="https://www.linkedin.com/in/karen-lorena-figueroa-chilito/",children=[
                                        html.I(className="fa fa-linkedin")
                                    ])                                    
                                ])
                            ])
