...
layout = go.Layout(title="Average Traffic Incidents", xaxis={"title": "Date"}, yaxis={"title": "# Siniestros"})
fig_init = go.Figure(
    data=data,
    layout=layout
)
    ...
    dbc.Row([
        ...
        dbc.Col(className="col-md-10" ,children=[
            ...
            dbc.Row([
                ...
                dbc.Col([
                    kpi_component(
                        header="The day with least Traffic Incidents predicted is...",
                        body="{}\nwith {} Traffic Incidents".format(day_least_sinisters, num_least_sinisters),
                ...
                dbc.Col([
                    kpi_component(
                        header="Day with most Traffic Incidents predicted",
                        body="{}\nwith {} Traffic Incidents".format(day_most_sinisters, num_most_sinisters),
...
def on_button_click(start_date, end_date):
    ...
    if start_date is None or end_date is None:
        ...
        return [
            fig,
            str(0),
            "{}\nwith {} Traffic Incidents".format("unknown", 0),
            "{}\nwith {} Traffic Incidents".format("unknown", 0),
            "",
            ""
        ]
